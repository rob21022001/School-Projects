        ...
        while(accomplished == false){
            ...
            if(s == DOMINANT|| t < Dogan){
                ...
                for(i=1; i<13; i++){
                    ...
                    if(read_button_state(2) == 1){
                        pushed = 1;
                        xil_printf("pushed2 = %d\n", pushed);
                    }
                }
            ...
            if(read_button_state(2) == 1 || pushed == 1){
                t = read_global_timer();
                ...
                xil_printf("client 1.4 starts sending\n");
        ...
        while(accomplished == false){            
            ...
            if(t > sendtime){
                ...
                if(accomplished == false){
                    ...
                    if(Scarpa > (PERIOD1/FRAME_LENGTH_CYCLES)-1){
                    ...
                    sendtime = sendtime + PERIOD1 - FRAME_LENGTH_CYCLES*Scarpa;
                    Scarpa = 0;
                }
            }
        }
